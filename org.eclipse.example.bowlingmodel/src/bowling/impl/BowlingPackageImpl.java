...
public class BowlingPackageImpl extends EPackageImpl implements BowlingPackage {
	 ...
	 * @generated
	 */
	public EReference getLeague_Subleagues() {
	 ...
	 * @generated
	 */
	public EReference getLeague_Tournaments() {
	...
	public void createPackageContents() {
		...
		createEReference(leagueEClass, LEAGUE__SUBLEAGUES);
		createEReference(leagueEClass, LEAGUE__TOURNAMENTS);
	...
	public void initializePackageContents() {
		...
		initEReference(getLeague_Subleagues(), this.getLeague(), null, "subleagues", null, 0, -1, League.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLeague_Tournaments(), this.getTournament(), null, "tournaments", null, 0, 1, League.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
